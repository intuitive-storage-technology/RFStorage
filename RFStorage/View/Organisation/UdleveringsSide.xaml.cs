...
namespace RFStorage.View.Organisation
{
    ...
    /// </summary>
    public sealed partial class UdleveringsSide : Page
    {
        public UdleveringsSide()
        {
        ...
        private void OrganList_OnSelectionChanged(object sender, SelectionChangedEventArgs e)
        {
